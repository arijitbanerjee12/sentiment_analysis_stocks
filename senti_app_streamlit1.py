...
if options == 'Sentiment Analysis':
    ...
    st.write ("This app is going to help you in getting the sentiments attached with news. We all know that the stock prices of the company depends on the news about the company  if the news is positive then the stock pricesa re more likely to go up and vise versa. So this app is going to help you to figure out if the newsa re positive or negative When you give us the Company ticker(symbol of the company) we are going to search the most relevent news about the company and then apply Machinne learning algorithms to figure out if those news are  positive or negative then give you a overall sentiments for all the news which is going to help you to decide if the share price will go up or down  ")
